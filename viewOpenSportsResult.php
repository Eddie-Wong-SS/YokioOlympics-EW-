<?php
/**
Shows the results of unscheduled sports search
 */
...
?>
<title>Unscheduled Sport Records</title>
        ...
        if(mysqli_num_rows($Result) > 0)
        {
            ...
            <form method="post" action="">
                <?php if($maxPage > 1 && $page != $maxPage) //Checks if 'back' button should be shown
                    echo "<button><a style='font-size: 21px'  href='viewOpenSportsResult.php?page=".($page-1)."'>&#60;</a> </button>";
                ...
                <table align="center">
                    ...
                    for($i = $minLim ; $i <= $maxLim; ++$i)
                    {
                        ...
                        echo "<td style='text-align: center'><a class='hoverme' href=\"addSchedule.php?Id=".$RowInfo['sportID']."\">Schedule Sport</a></td>";
                        echo "</tr>";
                    }
                    ?>
                </table>
