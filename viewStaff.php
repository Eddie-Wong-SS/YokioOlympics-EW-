...
<body>
<div class="container">
<?php if($_SESSION['AccType'] == "ADMIN") //Only admins can view all staff records
{
    ?>
    <h1>View Staff</h1>
    ...
    if($_REQUEST['btnSearch']) //Submit button is clicked
    {
        ...
        $_SESSION['SQL'] = $SQL;
        echo "<script>location='viewStaffResult.php?page=1'</script>"; //Takes the user to the next page
    }
    ?>
</div>
</body>
